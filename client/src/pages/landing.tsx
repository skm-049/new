...
export default function Landing() {
  useEffect(() => {
    ...
    const interval = setInterval(updateBackgroundForTimeOfDay, 3600000); // Update every hour
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-muted-foreground">
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-web-dev">Web Development</a>
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-ai-integration">AI Integration</a>
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-mobile-apps">Mobile Apps</a>
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-consulting">Consulting</a>
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-code-review">Code Review</a>
                <a href="#" className="block hover:text-primary transition-colors" data-testid="link-technical-writing">Technical Writing</a>
              </div>
            </div>
          </div>
